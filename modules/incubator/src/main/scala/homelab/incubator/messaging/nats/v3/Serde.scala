 ...
 * resolved implicitly at each producer/consumer. A real version would be backed by zio-json/zio-schema
 * and carry headers; kept minimal here to explore where the seam sits.
 *
