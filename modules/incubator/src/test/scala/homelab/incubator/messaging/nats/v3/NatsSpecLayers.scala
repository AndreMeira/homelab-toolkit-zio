...
/**
 * Test wiring for the NATS v3 (JetStream) sketch: a single scoped [[Connection]] over a throwaway
 * Testcontainers NATS server '''started with JetStream enabled''' (`-js`). Mirrors
