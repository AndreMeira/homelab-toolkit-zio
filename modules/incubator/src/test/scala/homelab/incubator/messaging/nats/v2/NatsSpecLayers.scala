...
/**
 * Test wiring for the NATS v2 sketch: a single scoped [[Connection]] over a throwaway Testcontainers
 * NATS server. Mirrors `homelab.postgres.PostgresSpecLayers`. Requires a running Docker daemon.
 */
